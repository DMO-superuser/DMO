...
while True:
  ...
  kit2.stepper1.onestep(direction=stepper.BACKWARD, style=stepper.INTERLEAVED)
  kit2.stepper2.onestep(direction=stepper.BACKWARD, style=stepper.MICROSTEP)
  ...
  kit4.stepper1.onestep(direction=stepper.BACKWARD, style=stepper.INTERLEAVED)
  kit4.stepper2.onestep(direction=stepper.BACKWARD, style=stepper.MICROSTEP)
